...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Jan 2023 pada 23.35
...
CREATE TABLE `tb_agenda` (
  `id` int(11) NOT NULL,
  `tanggal` varchar(132) NOT NULL,
  `judul` varchar(121) NOT NULL,
...
INSERT INTO `tb_agenda` (`id`, `tanggal`, `judul`, `tempat`, `icon`) VALUES
(2, '2023-01-12T18:12', 'Bagi Rapot Siswa', 'SMK informatika sumedang', ''),
(4, '2023-01-06T18:50', 'Bagi Rapot', 'Sumedang', '');
...
(7, 'pengenalan-oop-pada-php', 'Pengenalan OOP pada php', 'tutorial,php,oop', 'OOP (Object-Oriented Programming) adalah metode pemrograman yang mengutamakan pembuatan objek sebagai dasar dari pemrograman. PHP adalah bahasa pemrograman yang mendukung OOP, yang memungkinkan Anda untuk menggunakan konsep-konsep seperti kelas, objek, inheritance, polymorphism, dan encapsulation dalam pembuatan aplikasi.\r\n\r\nKetika menggunakan OOP', '/public/storage/post/thumbnail/default.jpg', '<p>OOP (Object-Oriented Programming) adalah metode pemrograman yang mengutamakan pembuatan objek sebagai dasar dari pemrograman. PHP adalah bahasa pemrograman yang mendukung OOP, yang memungkinkan Anda untuk menggunakan konsep-konsep seperti kelas, objek, inheritance, polymorphism, dan encapsulation dalam pembuatan aplikasi.</p>\r\n<p>Ketika menggunakan OOP di PHP, Anda dapat membuat kelas yang menentukan properti dan metode yang dimiliki oleh objek. Anda dapat kemudian menciptakan objek dari kelas tersebut dan menggunakannya dalam aplikasi Anda.</p>\r\n<p>Contoh dari pembuatan kelas dan objek di PHP :</p>\r\n<pre class=\"language-php\"><code>class Car {\r\n    public $brand;\r\n    public $model;\r\n    public $year;\r\n    public function honk() {\r\n        return \"Honk honk!\";\r\n    }\r\n}\r\n\r\n$myCar = new Car();\r\n$myCar->brand = \"Toyota\";\r\n$myCar->model = \"Camry\";\r\n$myCar->year = 2020;\r\n\r\necho $myCar->brand; // Toyota\r\necho $myCar->honk(); // Honk honk!\r\n</code></pre>\r\n<p>OOP di PHP juga menyediakan fitur seperti inheritance, yang memungkinkan Anda untuk menurunkan kelas dari kelas lain, dan polymorphism, yang memungkinkan Anda untuk mengubah perilaku kelas dan objek berdasarkan konteks.</p>\r\n<p>Secara keseluruhan, OOP di PHP membantu untuk meningkatkan kualitas kode, membuat kode lebih mudah dipelihara dan dikembangkan, dan memungkinkan Anda untuk menyusun aplikasi yang lebih kompleks dengan cara yang lebih terstruktur.</p>', NULL, 2, '2023-01-22T10:37:12', '', 1, 0, 'publish');
...
INSERT INTO `tb_users` (`id`, `nama_lengkap`, `email`, `password`, `jabatan`, `level`, `create_at`, `avatar`) VALUES
(1, 'dadanhiayat', 'dadan@dadan.com', '$2y$10$hEHA/OxiCE5CaYQ52iv83eFobpGPOolx3C4jrV4YxzfbhfTq8RBii', 'Administrator', 'super_admin', '', '');
...
--
ALTER TABLE `tb_post`
  MODIFY `id` int(14) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
