                    ...
                    <div class="container">
                        ...
                        <?php if (!isset($_SERVER['PATH_INFO'])): ?>
                            ...
                            <?php else: ?>
                                    ...
                                    <div class="dropdown-content">
                                        ...
                                        if ($data = $model->get()->getResult()) {
                                            foreach ($data as $value) {
                                                ?>
                                                <a
                                                    href="<?php echo site_url(route_to('frontend_detail_komli', $value->id, $value->slug)); ?>"><?php
                                                        echo $value->nama_komli; ?></a>
                                                <?php
                                            }
                                        }
                                        ?>
                                        <a href="<?php echo site_url(route_to('frontend_sambutan_kepala_sekolah')) ?>">Sambutan
                                            Kepala Sekolah</a>
                                        <a href="<?php echo site_url(route_to('frontend_struktur_organisasi')); ?>">Stuktur
                                            Organisasi</a>
                                        <a href="<?php echo site_url(route_to('frontend_visimisi')); ?>">Visi & Misi</a>
                                        <a href="<?php echo site_url(route_to('frontend_budaya_sekolah')); ?>">Budaya
                                            Sekolah</a>
                                        <a href="<?php echo site_url(route_to('frontend_fasilitas')); ?>">Budaya
                                            Sekolah</a>
                                ...
                                <?php if (isset($_SERVER['PATH_INFO'])): ?>
                                    <a href="ppdb.html" id="nav_btn" class="btn btn-sm ">PPDB</a>
                                <?php else: ?>
                                    <a href="ppdb.html" id="nav_btn" class="btn btn-sm">PPDB</a>
                                <?php endif; ?>
